...
import com.team.ecommerce.other.ConfigVNPay;
...
public class VNPayService {
    ...
    public String createPayment(Order order) throws UnsupportedEncodingException {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
//        String orderType = req.getParameter("ordertype");
        long amount = (order.getTotalOrderPrice())*100;
